...
public class OrderDetailsWholesalerActivity extends AppCompatActivity {
        ...
        reference.child(mauth.getUid()).child("Orders").child("OrderId")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(OrderDetailsWholesalerActivity.this, "Order is now" + selectedOption, Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(OrderDetailsWholesalerActivity.this, "e.getMessage()", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        reference.child(mauth.getUid()).child("Orders").child("orderId").child("Items")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup adapter
                        adapterOrderedItem = new AdapterOrderedItem(OrderDetailsWholesalerActivity.this, orderedItemArrayList);
                        //set adapter
